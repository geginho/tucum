            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'       => 'enable_slideshow',
                        'type'     => 'switch',
                        'title'    => __( 'Have the top background image as a slideshow?', 'redux-framework-demo' ),
                        'default'  => false,
                    ),
                    array(
                        'id' => 'bg_image2',
                        'required' => array( 'enable_slideshow', '=', '1' ),
                        'type' => 'media',
                        'title' => 'Background image #2',
                        'desc' => 'The #2 image in the top background slideshow.'
                    ),
                    array(
                        'id' => 'bg_image3',
                        'required' => array( 'enable_slideshow', '=', '1' ),
                        ...
                        'desc' => 'The #3 image in the top background slideshow.'
                    ),
                    array(
                        'id' => 'bg_image4',
                        'required' => array( 'enable_slideshow', '=', '1' ),
                        ...
                        'desc' => 'The #4 image in the top background slideshow.'
                    ),
                    array(
                        'id' => 'bg_image5',
                        'required' => array( 'enable_slideshow', '=', '1' ),
                        ...
                        'desc' => 'The #5 image in the top background slideshow.'
                    ),
                    array(
                        'id' => 'bg_color',
                        'type' => 'color',
                    ...
                    array(
                        ...
                        'desc' => 'This is the e-mail showing up on the contact page',
                        'default' => get_bloginfo('admin_email')
                    ),
                    array(
                        'id'       => 'show_metainfo',
                        'type'     => 'switch',
                        'title'    => __( 'Show meta info for blog posts? (author name, post date, etc)', 'redux-framework-demo' ),
                        'default'  => true,
                    ),
                    array(
                        'id' => 'blog_page',
