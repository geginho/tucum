...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'context'    => 'normal',
		'priority'   => 'high',
		'show_on'    => array( 'key' => 'page-template', 'value' => 'page-template-blog.php', 'value' => 'single-template'),
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array( // Text Input
			    'name' => 'Botão site', // <label>
			    'desc'  => 'The text on the call to action button, if applicable. ', // description
			    'id'    => $prefix . 'buttontext2', // field id and name
			    'type'  => 'text', // type of field,
			    ),
			array( // Text Input
			    'name' => 'Botão site URL', // <label>
			    'desc'  => 'The url on the call to action button, if applicable. ', // description
			    'id'    => $prefix . 'buttonurl2', // field id and name
			    'type'  => 'text', // type of field,
			    ),
	...
	$meta_boxes[] = array(
		'id'         => 'portf_metabox',
		'title'      => 'Slider',
		'pages'      => array( 'projetos', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'fields' => array(
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array( // Text Input
			    'name' => 'Slogan background image url', // <label>
