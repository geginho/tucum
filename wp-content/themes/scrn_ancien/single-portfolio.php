...
$buttontext2 = get_post_meta($post->ID, '_portfolio_buttontext2', true);
$buttonurl = get_post_meta($post->ID, '_portfolio_buttonurl', true);
$buttonurl2 = get_post_meta($post->ID, '_portfolio_buttonurl2', true);
...
?>
	...
	<div class="one-third column">
		<p class="s-proj-title"><?php echo $title;?></p>
		<div class="button1 close close_projeto">X</div>
		<?php if($type != '') { ?>
			<p class="s-proj-type"><?php echo $type;?></p>
		<?php } ?>
		<p><?php echo htmlspecialchars_decode($description);?></p>
		<?php if($buttontext != '') { ?>
			<a target="_blank" href="http://<?php if($buttonurl != '') echo $buttonurl; else echo '#';?>">
				<div class="button1"><?php echo $buttontext;?></div>
			</a>
		<?php } ?>
        <?php if($buttontext2 != '') { ?>
            <a target="_blank" href="http://<?php if($buttonurl2 != '') echo $buttonurl2; else echo '#';?>">
        		<div class="button1"><?php echo $buttontext2;?></div>
            </a>
        <?php } ?>
